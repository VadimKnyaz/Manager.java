...
class Practicum {
    ...
    private static void printFlightInformation(
        ...
        ZonedDateTime arrival = ZonedDateTime.of(LocalDateTime.from(departure.plus(flightDuration)),ZoneId.of(arrivalAirport.getZone()));
...
//задачу, все принципы ооп,гарбеджеколектор, finalize().
//разобрать задачу полностью что куда откуда , коллекции , доклад интерфейс клонабел , метод клон класса обжект с примерами несколько